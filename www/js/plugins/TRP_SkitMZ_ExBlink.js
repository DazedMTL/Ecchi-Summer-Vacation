...
(function () {
  ...
  var parameters = JSON.parse(
    JSON.stringify(PluginManager.parameters(pluginName), function (key, value) {
      try {
  ...
  SkitActor.prototype.setBlinkWait = function () {
    this._blinkWait =
      parameters.minFrame +
      Math.max(0, Math.randomInt(parameters.maxFrame - parameters.minFrame));
  };
  ...
  // Sprite_Picture
  //=============================================================================
  var _Sprite_Picture_convertSkitOverlayPartsId =
    Sprite_Picture.convertSkitOverlayPartsId;
  Sprite_Picture.convertSkitOverlayPartsId = function (
    ...
    if (
      ...
      if (poseData.blinkIds) {
        ...
        elem =
          ...
          poseData.blinkKind +
          ":" +
          poseData.blinkIds[Math.min(blinkIdx, poseData.blinkIds.length - 1)];
      } else {
        return;
      }
    ...
    _Sprite_Picture_convertSkitOverlayPartsId.call(
      this,
      ret,
      elem,
      poseData,
