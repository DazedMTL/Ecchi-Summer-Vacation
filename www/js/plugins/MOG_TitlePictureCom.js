...
Moghunter.title_zoomEffect = String(
  Moghunter.parameters["Zoom Effect"] || "true"
);
Moghunter.title_zoomDuration = Number(Moghunter.parameters["Zoom Speed"] || 40);
Moghunter.title_FadeInDuration = Number(
  Moghunter.parameters["Fade-In Duration"] || 40
);
Moghunter.title_comMode = Number(Moghunter.parameters["Animation Mode"] || 2);
Moghunter.title_ComFadeInDuration = Number(
  Moghunter.parameters["Com Fade-In Duration"] || 13
);
Moghunter.title_sideInput = String(
  Moghunter.parameters["Left & Right Input"] || "true"
);
Moghunter.title_subPicture = String(
  Moghunter.parameters["Smart Background"] || "true"
);
...
Moghunter.title_subPictureX = Number(
  Moghunter.parameters["Background X-Axis"] || 0
);
Moghunter.title_subPictureY = Number(
  Moghunter.parameters["Background Y-Axis"] || 0
);
Moghunter.title_subFadeInDuration = Number(
  Moghunter.parameters["Background Fade-In Duration"] || 90
);
...
Scene_Title.prototype.updateCursor = function () {
  ...
  var nx =
    ...
    this._cursorSlide[0] -
    this.comSprite().shake[0] +
    this._cursor.org[0]; //+ (this._cursor.width / 2)  + this._cursorSlide[0];
  var ny =
    this.comSprite().y -
...
Scene_Title.prototype.createTitleSprite = function () {
  ...
  this._gameTitleSprite.zoomEffect =
    Moghunter.title_zoomEffect == "true" ? true : false;
  this._gameTitleSprite.fadeInDuration = Moghunter.title_zoomDuration;
  this._gameTitleSprite.zoomSpd = 0.5 / this._gameTitleSprite.fadeInDuration;
  this._gameTitleSprite.opcSpd = 150 / this._gameTitleSprite.fadeInDuration;
  if (this._gameTitleSprite.zoomEffect) {
    this._gameTitleSprite.scale.x = 1.5;
...
Scene_Title.prototype.updateTitleSprite = function () {
  ...
  if (this._gameTitleSprite.scale.x > 1.0) {
    this._gameTitleSprite.scale.x -= this._gameTitleSprite.zoomSpd;
    if (this._gameTitleSprite.scale.x <= 1.0) {
      this._gameTitleSprite.scale.x = 1.0;
    }
  }
  this._gameTitleSprite.scale.y = this._gameTitleSprite.scale.x;
};
