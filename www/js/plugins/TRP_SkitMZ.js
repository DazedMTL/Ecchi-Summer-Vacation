...
===================================*/
  ...
  TRP_CORE.convertEscapeCharacters =
  ...
  TRP_CORE.setupTRPSkitConfigParametersIfNeeded = function () {
    ...
    TRP_CORE.skitParameters = parameters = JSON.parse(
      JSON.stringify(TRP_CORE.skitParameters, function (key, value) {
        try {
    ...
    try {
      ...
      e = new Error(
        errorPrefix + "アニメーションの登録設定が正しくありません。"
      );
      SceneManager.catchException(e);
    }
    ...
    try {
      var macroArray = parameters.macro
        ...
        .concat(parameters.macro3)
        .concat(parameters.macro4);
    ...
    try {
      parameters.unFocus.tone = TRP_CORE.interpretToneStr(
        parameters.unFocus.tone
      );
    } catch (e) {
    ...
    try {
      parameters.emphasize.tone = TRP_CORE.interpretToneStr(
        parameters.emphasize.tone
      );
    } catch (e) {
    ...
    if (parameters.useMultiLayer && parameters.useSpritesheets) {
      const spritesheets =
        parameters.spritesheets === ""
          ? []
          : parameters.spritesheets.split(",");
...
===================================*/
  ...
  TRP_CORE.easingInElastic = function (t) {
    ...
    return (
      -Math.pow(2, 10 * t) *
      Math.sin(((t - (0.4 / 2 / Math.PI) * Math.asin(1)) * 2 * Math.PI) / 0.4)
    );
  };
  TRP_CORE.easingOutElastic = function (t) {
    return (
      Math.pow(2, -10 * t) *
        Math.sin(
          ((t - (0.4 / 2 / Math.PI) * Math.asin(1)) * 2 * Math.PI) / 0.4
        ) +
      1
    );
  };
...
===================================*/
  ...
  TRP_CORE.processKeyValuePluginCommandArguments = function (
    elems,
    defaults,
    map = null,
    keys,
    ...
    if (exp) {
      if (parameters.useMultiLayer) {
        if (parameters.useSpritesheets) {
          ...
          var partsIds = Sprite_Picture.overlayPartsIds(
            true,
            folderName,
            pose,
            exp
...
===================================*/
  Skit.prototype.playAnimationSkitActor = function (args, macroPos) {
    ...
    var mirror = TRP_CORE.supplementDefBool(
      parameters.animation.mirror,
      args[4]
    );
...
===================================*/
  ...
  Skit.prototype.actorFolderName = function (name) {
    if (parameters.dataActors[name]) {
      ...
      if (
        parameters.nameToInputList[name] &&
  ...
  Skit.prototype._openPositionForAutoShow = function (actors, positions) {
    ...
    while (positions.length > 1 && candidates[positions[0]].length > 0) {
      ...
      uniquePositions.sort(function (a, b) {
        return (
          candidates[a][0][infoIdxOfDist] - candidates[b][0][infoIdxOfDist]
        );
      });
...
===================================*/
  SkitActor.prototype.show = function (position, opacity) {
    ...
    opacity = TRP_CORE.supplementDefNum(
      this._opacity < 0 ? 255 : this._opacity,
      opacity
    );
...
===================================*/
  SkitActor.prototype.fadeIn = function (
    ...
    easeType = TRP_CORE.supplementEasingArg(
      parameters.fadeIn.easeType,
      easeType
    );
    position = TRP_CORE.interpretPositionArg(position);
...
===================================*/
  SkitActor.prototype.slideIn = function (
    ...
    easeType = TRP_CORE.supplementEasingArg(
      parameters.slideIn.easeType,
      easeType
    );

    position = TRP_CORE.interpretPositionArg(position);
    slideLength = TRP_CORE.supplementDefNum(
      parameters.slideIn.slideLength,
      slideLength
    );
    ...
    var duration = this.movePosition(
      wait,
      easeType,
      position,
      speed,
  ...
  SkitActor.prototype.slideOut = function (
    wait,
    easeType,
    slideLength,
    speed,
    ...
    easeType = TRP_CORE.supplementEasingArg(
      parameters.slideOut.easeType,
      easeType
    );
    slideLength = TRP_CORE.supplementDefNum(
      parameters.slideOut.slideLength,
      slideLength
    );
    ...
    var position =
      this._position + (direction < 0 ? -slideLength : slideLength);
...
===================================*/
  SkitActor.prototype.shake = function (
    ...
    easeType = TRP_CORE.supplementEasingArg(
      parameters.shake.easeType,
      easeType
    );
    strength = TRP_CORE.supplementDefNum(parameters.shake.strength, strength);
    speedDur = TRP_CORE.supplementDefNum(
      parameters.shake.durationPerCount,
      speedDur
    );
    count = TRP_CORE.supplementDefNum(parameters.shake.count, count);
    reverse = TRP_CORE.supplementDefBool(
      parameters.shake.reverse || false,
      reverse
    );
  ...
  SkitActor.prototype.processShake = function (
    easeType,
    strength,
    speedDur,
    count,
    ...
    count -= 1;
    if (count > 0) {
      this.pushTimerCommand(duration, "processShake", [
        easeType,
        strength,
        speedDur,
        count,
...
===================================*/
  SkitActor.prototype.changeExpression = function (wait, expression, duration) {
    ...
    duration = TRP_CORE.supplementDefNum(
      parameters.expression.duration,
      duration
    );
  ...
  SkitActor.prototype.changePose = function (
    wait,
    easeType,
    pose,
    expression,
  ...
  SkitActor.prototype.changeImageWithFlipAnimation = function (
    wait,
    easeType,
    duration
  ) {
    ...
    this.pushTimerCommand(duration, "changeImageStartFlipEmerge", [
      false,
      easeType,
      duration,
    ]);
  ...
  SkitActor.prototype.changeImageWithFadeAnimation = function (
    wait,
    easeType,
    duration
  ) {
    ...
    this.pushTimerCommand(duration, "changeImageStartFadeEmerge", [
      false,
      easeType,
      duration,
      opacity,
...
===================================*/
  SkitActor.prototype.changeOpacity = function (
    ...
    relative = TRP_CORE.supplementDefBool(
      parameters.opacity.easeType.relative,
      relative
    );
...
===================================*/
  SkitActor.prototype.emphasize = function (
    ...
    duration = TRP_CORE.supplementDefNum(
      parameters.emphasize.duration,
      duration
    );
    scaleX =
      TRP_CORE.supplementDefNum(parameters.emphasize.scaleX, scaleX) / 100;
    scaleY =
      TRP_CORE.supplementDefNum(parameters.emphasize.scaleY, scaleY) / 100;
    num = TRP_CORE.supplementDefNum(parameters.emphasize.num, num);
    interval = TRP_CORE.supplementDefNum(
      parameters.emphasize.interval,
      interval
    );
...
===================================*/
  ...
  SkitActor.prototype.changeFocusScale = function (
    wait,
    easeType,
    duration,
    scale
...
===================================*/
  ...
  SkitActor.prototype.movePositionDur = function (
    wait,
    easeType,
    position,
    duration,
...
===================================*/
  SkitActor.prototype.moveYPosition = function (
    ...
    easeType = TRP_CORE.supplementEasingArg(
      defParams ? defParams.easeType : TRP_CORE.EASING.easeOutQuad,
      easeType
    );
    position = TRP_CORE.interpretPositionArg(position);
    duration = TRP_CORE.supplementSpeedArg(
      defParams ? defParams.duration : 20,
      duration
    );
    relative = TRP_CORE.supplementDefBool(false, relative);
    ...
    this._offsetY =
      position + (relative ? this._offsetY : pose ? pose.displayOffsetY : 0);
...
===================================*/
  SkitActor.prototype.flip = function (wait, easeType, num, durationPerCount) {
    ...
    durationPerCount = TRP_CORE.supplementDefNum(
      parameters.flip.durationPerCount,
      durationPerCount
    );
  ...
  SkitActor.prototype.changeYAngle = function (
    wait,
    easeType,
    angle,
    duration,
...
===================================*/
  ...
  SkitActor.prototype.changeAngle = function (
    wait,
    easeType,
    angle,
    duration,
...
===================================*/
  ...
  SkitActor.prototype.applyPose = function (duration) {
    ...
    if (pose) {
      picture.setAnimationOffset(
        pose.animationOffsetX || 0,
        pose.animationOffsetY || 0
      );
    } else {
  ...
  SkitActor.prototype.wait = function (wait) {
    if (this._playingSequences[0]) {
      this._playingSequences[0]._waitCount = Math.max(
        wait,
        this._playingSequences[0]._waitCount
      );
    } else {
      this._waitCount = Math.max(wait, this._waitCount);
    }
...
===================================*/
  ...
  Game_Picture.prototype.showBust = function (
    skitActorName,
    name,
    origin,
    x,
...
===================================*/
  ...
  Game_Picture.prototype.changeOpacity = function (
    opacity,
    duration,
    relative,
    easeType
  ...
  Game_Picture.prototype.updateOpacityChange = function () {
    ...
    this._opacity = TRP_CORE.easingValue(
      t,
      this._startOpacity,
      this._deltaOpacity,
      this._opacityTotalDuration,
      this._opacityEaseType
    );
...
===================================*/
  ...
  Game_Picture.prototype.changeScale = function (
    scaleX,
    scaleY,
    duration,
    relative,
  ...
  Game_Picture.prototype.updateScaleChange = function () {
    ...
    this._scaleX = TRP_CORE.easingValue(
      t,
      this._startScaleX,
      this._deltaScaleX,
      this._scaleTotalDuration,
      this._scaleEaseType
    );
    this._scaleY = TRP_CORE.easingValue(
      t,
      this._startScaleY,
      this._deltaScaleY,
      this._scaleTotalDuration,
...
===================================*/
  ...
  Game_Picture.prototype.movePosition = function (
    x,
    y,
    duration,
    relative,
...
===================================*/
  ...
  Game_Picture.prototype.changeAngle = function (
    angle,
    duration,
    relative,
    easeType
  ...
  Game_Picture.prototype.updateAngleChange = function () {
    ...
    this._angle = TRP_CORE.easingValue(
      t,
      this._startAngle,
      this._deltaAngle,
      this._angleTotalDuration,
      this._angleEaseType
    );
  };
...
===================================*/
  ...
  Game_Picture.prototype.changeYAngle = function (
    angle,
    duration,
    relative,
    easeType
  ...
  Game_Picture.prototype.updateYAngleChange = function () {
    ...
    this._yAngle = TRP_CORE.easingValue(
      t,
      this._startYAngle,
      this._deltaYAngle,
      this._yAngleTotalDuration,
      this._yAngleEaseType
    );
  };
...
===================================*/
  ...
  Sprite_Picture.prototype.loadBitmap = function () {
    if (this.isBustPicture()) {
      ...
      var bitmap = ImageManager.loadBust(
        this._skitActorName,
        this._pictureName
      );
      bitmap.addLoadListener(
        this.didLoadPoseImage.bind(this, this._pictureName, bitmap)
      );
...
===================================*/
  ...
  Sprite_Picture.prototype.updateBustPicture = function (
...
===================================*/
  ...
  Sprite_Picture.prototype.overlayPartsIds = function (useMultiLayer) {
    ...
    return Sprite_Picture.overlayPartsIds(
      useMultiLayer,
      actorName,
      poseName,
      overlayName
  ...
  Sprite_Picture.overlayPartsIds = function (
    useMultiLayer,
    actorName,
    poseName,
    overlayName
  ...
  Sprite_Picture.convertSkitOverlayPartsId = function (
    ret,
    elem,
    poseData,
    exps
  ...
  Sprite_Picture.prototype.shiftSameTypeOverlay = function (
    overlays,
    partsKind,
    partsId
  ) {
  ...
  Sprite_Picture.prototype.changeOverlay = function (picture) {
    ...
    for (var kind = length - 1; kind >= 0; kind = (kind - 1) | 0) {
      ...
      if (currentOverlay) {
        if (
          useMultiLayer
            ? currentOverlay.equalsMultiLayer(
                actorName,
                poseName,
                kind,
                partsId
      ...
      if (useMultiLayer) {
        ...
        newOverlay.setupSingleLayer(actorName, poseName, partsId, this);
      ...
      if (currentOverlay && !useMultiLayer && duration === 0) {
        ...
        newOverlay.bitmap.addLoadListener(
          this.removeOverlay.bind(this, currentOverlay)
        );
...
===================================*/
  ...
  Sprite_Picture.prototype.emphasize = function (
    duration,
    scaleX,
    scaleY,
    tone,
...
===================================*/
  ...
  Sprite_SkitEmphasis.prototype.copySprite = function (
    original,
    target = new Sprite()
  ) {
    ...
    target.setFrame(
      original._frame.x,
      original._frame.y,
      original._frame.width,
      original._frame.height
    );
  ...
  Sprite_SkitEmphasis.prototype.setup = function (
    duration,
    scaleX,
    scaleY,
    tone,
    ...
    this._deltaScaleY =
      TRP_CORE.supplementDefNum(this._deltaScaleX + startScale, scaleY) -
      startScale;
  ...
  Sprite_SkitEmphasis.prototype.updateAnimation = function () {
    ...
    if (ed <= 0) {
      ...
      this.opacity = TRP_CORE.easingValue(
        t,
        this._startOpacity,
        this._deltaOpacity,
        td,
      ...
      this.scale.x = TRP_CORE.easingValue(
        t,
        this._startScaleX,
        this._deltaScaleX,
        td,
      ...
      this.scale.y = TRP_CORE.easingValue(
        t,
        this._startScaleY,
        this._deltaScaleY,
        td,
  ...
  Sprite_SkitOverlay.get = function () {
    ...
    if (!instance) {
      ...
      instance.texture = new PIXI.Texture(
        Sprite._emptyBaseTexture,
        new Rectangle()
      );
  ...
  Sprite_SkitOverlay.prototype.equalsMultiLayer = function (
    actorName,
    poseName,
    partsKind,
    partsId
  ...
  Sprite_SkitOverlay.prototype.equalsSingleLayer = function (
    actorName,
    poseName,
    expName
  ) {
  ...
  Sprite_SkitOverlay.prototype._setupCommon = function (
    sprite,
    actorName,
    poseName
  ) {
  ...
  Sprite_SkitOverlay.prototype.setupMultiLayer = function (
    useSpritesheets,
    actorName,
    poseName,
    partsKind,
  ...
  Sprite_SkitOverlay.prototype.loadBitmapForMultiLayer = function (
    useSpritesheets,
    actorName,
    poseName,
    partsKind,
  ...
  Sprite_SkitOverlay.prototype.setupSingleLayer = function (
    actorName,
    poseName,
    expName,
    sprite
  ...
  Sprite_SkitOverlay.prototype.loadBitmapForSingleLayer = function (
    actorName,
    poseName,
    expName
  ) {
  ...
  Sprite_Animation.prototype.targetBustPictureSpritePosition = function (
    sprite
  ) {
    const point = new Point(
      sprite._animationOffset ? sprite._animationOffset.x : 0,
      (sprite._animationOffset ? sprite._animationOffset.y : 0) -
        (sprite.anchor.y - 0.5) * sprite.height
    );
...
===================================*/
  Spriteset_Base.prototype.findBustPictureTargetSprite = function (target) {
    if (this._bustPictureContainer) {
      return this._bustPictureContainer.children.find((sprite) =>
        sprite.checkPicture(target)
      );
    }
    return null;
  };
  ...
  Spriteset_Base.prototype.createAnimationSprite = function (
    ...
    if (targets[0] instanceof Game_Picture && targets[0]._skitActorName) {
      this.createAnimationSpriteForBustPicture(
        targets,
        animation,
        mirror,
        delay
      ...
      _Spriteset_Base_createAnimationSprite.call(
        this,
        targets,
        animation,
        mirror,
  ...
  Spriteset_Base.prototype.createAnimationSpriteForBustPicture = function (
    targets,
    animation,
    mirror,
    delay
...
===================================*/
  ...
  // Spriteset_Map
  //=============================================================================
  var _Spriteset_Map_findTargetSprite =
  ...
  // Spriteset_Battle
  //=============================================================================
  var _Spriteset_Battle_findTargetSprite =
    Spriteset_Battle.prototype.findTargetSprite;
  ...
  Game_Message.prototype.detectTrpSkitSpeakerWithSpeaker = function (
    speakerName
  ) {
  ...
  // Window_Message
  //=============================================================================
  var _Window_Message_processEscapeCharacter_ =
    Window_Message.prototype.processEscapeCharacter;
  Window_Message.prototype.processEscapeCharacter = function (code, textState) {
    if (this.processEscapeCharacterForSkit(code, textState)) {
      return;
    }
    _Window_Message_processEscapeCharacter_.call(this, code, textState);
  };

  Window_Message.prototype.processEscapeCharacterForSkit = function (
    code,
    textState
  ) {
    ...
    if (code === (skitCodes.pose || "SP")) {
      ...
      var pose = params[0];
      expression = params[1];
      $gameSkit.processCommand([
        "pose",
        $gameMessage._talkingActorName,
        "f",
        pose,
        expression,
      ]);
      ...
      $gameSkit.processCommand(
        [command, $gameMessage._talkingActorName, "f"].concat(args)
      );
      return true;
  ...
  Game_Interpreter.prototype.skitTest = function () {
    ...
    var list = [
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      {
        code: 401,
        indent: 0,
        parameters: ["動作名の表示のあとに、コマンドを実行します。"],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←フェードイン"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["キャラ名 = yuna"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["位置 = def"] },
      { code: 657, indent: 0, parameters: ["所要時間 = def"] },
      { code: 657, indent: 0, parameters: ["不透明度 = 255"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 657, indent: 0, parameters: ["プッシュイン = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      {
        code: 401,
        indent: 0,
        parameters: [
          "\\>←スライドイン(登場位置がかぶるときはキャラを押し避ける)",
        ],
      },
      {
        code: 357,
      ...
      { code: 657, indent: 0, parameters: ["キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["位置 = left"] },
      { code: 657, indent: 0, parameters: ["スライド距離 = def"] },
      { code: 657, indent: 0, parameters: ["スライドスピード = def"] },
      { code: 657, indent: 0, parameters: ["スライド方向。 = auto"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 657, indent: 0, parameters: ["プッシュイン = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>→反転"] },
      {
        code: 357,
        indent: 0,
        parameters: [
          ...
          "[動作]flip/キャラの反転",
          {
            ...
            wait: "true",
            num: "4",
            durationPerCount: "def",
            easeType: "def",
          },
        ],
      },
      { code: 657, indent: 0, parameters: ["対象キャラ名 = yuna"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["反転回数 = 4"] },
      { code: 657, indent: 0, parameters: ["１回の時間 = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←反転しつつ移動"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = false"] },
      { code: 657, indent: 0, parameters: ["位置 = right"] },
      { code: 657, indent: 0, parameters: ["移動スピード = def"] },
      { code: 657, indent: 0, parameters: ["相対座標フラグ = false"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      {
        code: 357,
        indent: 0,
      ...
      { code: 657, indent: 0, parameters: ["対象キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["反転回数 = def"] },
      { code: 657, indent: 0, parameters: ["１回の時間 = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←ステップ"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["対象キャラ名 = yuna"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["位置 = center"] },
      { code: 657, indent: 0, parameters: ["移動スピード = def"] },
      { code: 657, indent: 0, parameters: ["高さ = def"] },
      { code: 657, indent: 0, parameters: ["重力係数 = def"] },
      { code: 657, indent: 0, parameters: ["相対座標フラグ = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←強調"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["所要時間 = def"] },
      { code: 657, indent: 0, parameters: ["横方向の拡大率 = def"] },
      { code: 657, indent: 0, parameters: ["縦方向の拡大率 = def"] },
      { code: 657, indent: 0, parameters: ["演出の回数 = def"] },
      { code: 657, indent: 0, parameters: ["演出の間隔 = def"] },
      { code: 657, indent: 0, parameters: ["R値[赤] = def"] },
      { code: 657, indent: 0, parameters: ["G値[緑] = def"] },
      { code: 657, indent: 0, parameters: ["B値[青] = def"] },
      { code: 657, indent: 0, parameters: ["グレー = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←シェイク"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["対象キャラ名 = yuna"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["強さ = def"] },
      { code: 657, indent: 0, parameters: ["回数 = 2"] },
      { code: 657, indent: 0, parameters: ["１回の所要時間 = def"] },
      { code: 657, indent: 0, parameters: ["開始方向を反転 = false"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>→アニメーション"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["対象キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["アニメーション名 = 1"] },
      { code: 657, indent: 0, parameters: ["反転フラグ = def"] },
      { code: 657, indent: 0, parameters: ["自動フォーカスフラグ = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>→回転"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["対象キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["回転角度 = 360"] },
      { code: 657, indent: 0, parameters: ["所要時間 = def"] },
      { code: 657, indent: 0, parameters: ["相対角度フラグ = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>→表情"] },
      {
        code: 357,
        indent: 0,
        parameters: [
          ...
          "expression",
          "[表情/ポーズ]exp/表情変更",
          { name: "shizu", wait: "true", expression: "2", duration: "def" },
        ],
      },
      { code: 657, indent: 0, parameters: ["キャラ名 = shizu"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["表情名 = 2"] },
      { code: 657, indent: 0, parameters: ["所要時間 = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>←ポーズ"] },
      {
        code: 357,
        indent: 0,
        parameters: [
      ...
      { code: 657, indent: 0, parameters: ["キャラ名 = yuna"] },
      { code: 657, indent: 0, parameters: ["ウェイト = true"] },
      { code: 657, indent: 0, parameters: ["ポーズ名 = bend"] },
      { code: 657, indent: 0, parameters: ["表情名 = 3"] },
      { code: 657, indent: 0, parameters: ["アニメーションタイプ = def"] },
      { code: 657, indent: 0, parameters: ["所要時間 = def"] },
      { code: 657, indent: 0, parameters: ["イージング = def"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, "ユナ"] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>会話キャラの名前を検出して自動フォーカス"],
      },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>（話してないキャラが縮小＆暗く）"],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, "ユナ"] },
      { code: 401, indent: 0, parameters: ["会話中の制御文字のテスト。\\!"] },
      { code: 401, indent: 0, parameters: ["\\SE[5]\\\\SE[5]表情変更\\|"] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\SM[jump]\\\\SM[jump]ジャンプモーション"],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, "シズ"] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\SP[depressed]\\\\SP[depressed]ポーズ変更\\!"],
      },
      {
        code: 401,
        indent: 0,
        parameters: ["\\SA[1]\\\\SA[1]アニメーション\\!"],
      },
      {
        code: 401,
        indent: 0,
        parameters: ["\\SM[pop]\\\\SM[pop]登録マクロ~ポップジャンプ"],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2, ""] },
      { code: 401, indent: 0, parameters: ["\\>以上、正しく表示されていれば"] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>プラグインが動作する可能性が高いです。"],
      },
  ...
  Game_Interpreter.prototype.skitTestMV = function () {
    ...
    pushText(
      list,
      [
        "\\SP[depressed]\\\\SP[depressed]ポーズ変更\\!",
        "\\SA[1]\\\\SA[1]アニメーション\\!",
        "\\SM[pop]\\\\SM[pop]登録マクロ~ポップジャンプ",
      ],
      "シズ"
    );
    pushText(list, [
