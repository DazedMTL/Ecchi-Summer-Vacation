...
(function () {
  ...
  var paramHideNormalFollower = getParamBoolean([
    "HideNormalFollower",
    "通常フォロワーを表示しない",
  ]);
  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    this.pluginCommandNpcFollower(
      command.replace(new RegExp(metaTagPrefix, "i"), ""),
      args
    );
  };

  Game_Interpreter.prototype.pluginCommandNpcFollower = function (
    command,
    args
  ) {
