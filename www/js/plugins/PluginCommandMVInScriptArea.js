...
(() => {
  ...
  function setupPluginParameters() {
    const parameters = PluginManager.parameters(
      "PluginCommandMVInScriptArea".toLowerCase()
    );
    let expStr = "^(?:cmd";
  ...
  Game_Interpreter.prototype._processMvPluginCommandByScript = function (
    script
  ) {
  ...
  Game_Interpreter.processKeyValuePluginCommandArguments = function (
    elems,
    defaults,
    map = null,
    keys,
  ...
  Game_Interpreter.prototype.processKeyValuePluginCommandArguments =
    Game_Interpreter.processKeyValuePluginCommandArguments;
})();
