...
TMPlugin.EventItemEx.HelpWindowEnabledItem =
  TMPlugin.EventItemEx.Parameters["helpWindowEnabledItem"] === "true";
TMPlugin.EventItemEx.HelpWindowEnabledKey =
  TMPlugin.EventItemEx.Parameters["helpWindowEnabledKey"] === "true";
TMPlugin.EventItemEx.HelpWindowEnabledA =
  TMPlugin.EventItemEx.Parameters["helpWindowEnabledA"] === "true";
TMPlugin.EventItemEx.HelpWindowEnabledB =
  TMPlugin.EventItemEx.Parameters["helpWindowEnabledB"] === "true";
TMPlugin.EventItemEx.ShowItemNumberItem =
  TMPlugin.EventItemEx.Parameters["showItemNumberItem"] === "true";
TMPlugin.EventItemEx.ShowItemNumberKey =
  TMPlugin.EventItemEx.Parameters["showItemNumberKey"] === "true";
TMPlugin.EventItemEx.ShowItemNumberA =
  TMPlugin.EventItemEx.Parameters["showItemNumberA"] === "true";
TMPlugin.EventItemEx.ShowItemNumberB =
  TMPlugin.EventItemEx.Parameters["showItemNumberB"] === "true";
TMPlugin.EventItemEx.NumVisibleRowsItem = +(
  TMPlugin.EventItemEx.Parameters["numVisibleRowsItem"] || 4
);
TMPlugin.EventItemEx.NumVisibleRowsKey = +(
  TMPlugin.EventItemEx.Parameters["numVisibleRowsKey"] || 4
);
TMPlugin.EventItemEx.NumVisibleRowsA = +(
  TMPlugin.EventItemEx.Parameters["numVisibleRowsA"] || 4
);
TMPlugin.EventItemEx.NumVisibleRowsB = +(
  TMPlugin.EventItemEx.Parameters["numVisibleRowsB"] || 4
);
TMPlugin.EventItemEx.FixPlacement =
  TMPlugin.EventItemEx.Parameters["fixPlacement"];
...
(function () {
  ...
  var _Window_EventItem_updatePlacement =
  ...
  Window_EventItem.prototype.needsNumber = function () {
    var itypeId = $gameMessage.itemChoiceItypeId();
    return (
      (itypeId === 1 && TMPlugin.EventItemEx.ShowItemNumberItem) ||
